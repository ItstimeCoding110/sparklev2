  ...
  return (
    <div className="relative overflow-hidden bg-brand-pink/25 border-3 border-brand-dark p-6 md:p-10 rounded-4xl shadow-[6px_6.5px_0px_#121212] my-8 select-none">
      ...
      <div className="absolute top-4 right-4 hidden md:flex flex-col gap-2 rotate-6">
        <span className="bg-brand-pink font-display font-black text-xs border-2 border-brand-dark px-3 py-1 rounded shadow-[2.5px_2.5px_0px_#121212] uppercase tracking-wide flex items-center gap-1.5">
          <Flame className="w-3.5 h-3.5 text-brand-dark shrink-0" />
          <span>Limited Stock Terbatas</span>
        </span>
        <span className="bg-brand-blue font-display font-black text-xs border-2 border-brand-dark px-3 py-1 rounded shadow-[2.5px_2.5px_0px_#121212] uppercase tracking-wide -rotate-2 flex items-center gap-1.5">
          <Heart className="w-3.5 h-3.5 text-brand-dark shrink-0" />
          <span>100% Handmade</span>
        </span>
        <span className="bg-brand-mint font-display font-black text-[11px] border-2 border-brand-dark px-3 py-1 rounded shadow-[2.5px_2.5px_0px_#121212] uppercase tracking-wide rotate-3 flex items-center gap-1.5">
          <Box className="w-3.5 h-3.5 text-brand-dark shrink-0" />
      ...
      <div className="max-w-2xl space-y-6">
        {/* Playful Gen-Z tag */}
        <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-brand-mint border-2 border-brand-dark px-2.5 py-0.5 sm:py-1 rounded-full shadow-[2px_2.5px_0px_#121212] whitespace-nowrap">
          <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-brand-dark shrink-0" />
        ...
        <h1 className="font-display font-black text-3.5xl sm:text-5xl md:text-5.5xl text-brand-dark leading-[1.05] tracking-tight">
          WARNAI HARIMU DENGAN <span className="underline decoration-brand-orange decoration-wavy py-1">SPARKLE!</span> <Sparkles className="inline-block w-8 h-8 md:w-10 md:h-10 text-brand-orange align-middle" />
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-3">
          ...
          <button
            ...
            className="brutalist-button-pink py-3 text-sm px-6 flex items-center justify-start text-left gap-2 rounded-2xl font-display font-black tracking-wider shadow-[4.5px_4.5px_0px_#121212] hover:shadow-[6px_6px_0px_#121212] whitespace-nowrap"
          >
